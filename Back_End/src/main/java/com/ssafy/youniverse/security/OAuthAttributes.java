package com.ssafy.youniverse.security;

import com.ssafy.youniverse.entity.Member;
import com.ssafy.youniverse.security.oauth2.userinfo.GoogleOAuth2UserInfo;
...
public class OAuthAttributes {
    ...
    /**
     * ofGoogle메소드로 OAuthAttributes 객체가 생성되어, 유저 정보들이 담긴 OAuth2UserInfo가 소셜 타입별로 주입된 상태
